  ...
  return (
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <section className="relative isolate overflow-hidden bg-slate-950 text-white">
        ...
        <div className="container mx-auto px-4 py-14 md:py-20"><div className="max-w-3xl"><p className="text-sm font-black uppercase tracking-[.18em] text-blue-300">Services &amp; pricing</p><h1 className="mt-4 text-4xl font-black leading-[.98] tracking-tight sm:text-5xl md:text-6xl">Auto Detailing Services and Pricing</h1><p className="mt-5 max-w-2xl text-base leading-7 text-slate-200 md:text-lg">See what each service includes and where pricing starts. Larger vehicles and heavier cleanup can take more time, and I will explain any price change before I begin.</p><div className="mt-7 flex flex-col gap-3 sm:flex-row"><Link to="/book" className="inline-flex min-h-14 items-center justify-center bg-blue-600 px-7 font-black hover:bg-blue-700">Check Availability</Link><a href="sms:+17123056313?body=Hi%20Bryan%2C%20I%20need%20help%20choosing%20a%20detail.%20Here%20are%20photos%3A" className="inline-flex min-h-14 items-center justify-center gap-2 border border-white/50 px-7 font-black hover:bg-white hover:text-slate-950"><MessageSquare className="h-5 w-5" /> Text Me Photos</a></div></div></div>
      </section>
