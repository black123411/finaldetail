  ...
  return (
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <section className="relative isolate overflow-hidden bg-slate-950 text-white">
        ...
        <div className="container mx-auto px-4 py-14 md:py-20"><div className="max-w-3xl"><p className="text-sm font-black uppercase tracking-[.18em] text-blue-300">Services &amp; pricing</p><h1 className="mt-4 text-4xl font-black leading-[.98] tracking-tight sm:text-5xl md:text-6xl">Auto Detailing Services and Pricing</h1><p className="mt-5 max-w-2xl text-base leading-7 text-slate-200 md:text-lg">See what each service includes and where pricing starts. Larger vehicles and heavier cleanup can take more time, and I will explain any price change before I begin.</p><div className="mt-7 flex flex-col gap-3 sm:flex-row"><a href="#what-do-you-need" onClick={() => trackEvent('view_service_chooser', { location: 'services_hero' })} className="inline-flex min-h-14 items-center justify-center bg-blue-600 px-7 font-black hover:bg-blue-700">Choose a Service &amp; Book</a><a href="sms:+17123056313?body=Hi%20Bryan%2C%20I%20need%20help%20choosing%20a%20detail.%20Here%20are%20photos%3A" onClick={() => trackEvent('click_text_quote', { location: 'services_hero' })} className="inline-flex min-h-14 items-center justify-center gap-2 border border-white/50 px-7 font-black hover:bg-white hover:text-slate-950"><MessageSquare className="h-5 w-5" /> Text Me Photos</a></div><p className="mt-4 text-sm font-semibold text-slate-300">Standard detailing appointments book without a deposit. Ceramic coatings require a deposit. Square shows current availability and vehicle-size pricing.</p></div></div>
      ...
      <div className="container mx-auto px-4 py-10 md:py-16">
        ...
        <p className="mb-10 border-b border-slate-200 pb-6 text-sm font-semibold leading-6 text-slate-600">Starting prices vary by vehicle size and condition. Mobile service and Bellevue drop-off are available. Standard detailing is paid after the work is completed; ceramic coating bookings require a deposit.</p>
      ...
      <section className="bg-slate-950 py-16 text-white"><div className="container mx-auto flex flex-col justify-between gap-7 px-4 md:flex-row md:items-center"><div><h2 className="text-3xl font-black">Not sure which service to book?</h2><p className="mt-3 max-w-2xl text-slate-300">Text me a few clear photos and tell me what you want cleaned or corrected. I will take a look and give you a straight answer.</p></div><a href="sms:+17123056313?body=Hi%20Bryan%2C%20I%20need%20help%20choosing%20a%20detail.%20Here%20are%20photos%3A" onClick={() => trackEvent('click_text_quote', { location: 'services_footer' })} className="inline-flex min-h-14 shrink-0 items-center justify-center gap-2 bg-blue-600 px-7 font-black hover:bg-blue-700">Text Me Photos <ArrowRight className="h-5 w-5" /></a></div></section>
    </div>
  );
}