  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white">
      <div className="container mx-auto flex h-18 items-center justify-between gap-6 px-4">
        <Link to="/" className="max-w-[13rem] text-base font-black leading-tight tracking-tight text-slate-950 sm:max-w-none sm:text-lg lg:text-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
